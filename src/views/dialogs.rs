    ...
    column![
        ...
        container(
            column![
                ...
                text("1. We create separate .kdl files in ~/.config/niri/niri-settings/")
    ...
    column![
        ...
        container(
            column![
                ...
                text("  - Backups are created automatically in ~/.config/niri/niri-settings/backups/").size(12).color([0.7, 0.7, 0.7]),
            ]
            .spacing(4)
        )
        .padding([12, 16])

...
impl super::super::App {
    ...
    pub(in crate::app) fn update_miscellaneous(
        &mut self,
        msg: MiscellaneousMessage,
    ) -> Task<Message> {
        ...
        match msg {
            ...
            MiscellaneousMessage::SetDisablePrimaryClipboard(v) => {
                misc.disable_primary_clipboard = v
            }
            MiscellaneousMessage::SetHotkeyOverlaySkipAtStartup(v) => {
                misc.hotkey_overlay_skip_at_startup = v
            }
            MiscellaneousMessage::SetHotkeyOverlayHideNotBound(v) => {
                misc.hotkey_overlay_hide_not_bound = v
            }
        ...
        self.save
            .dirty_tracker
            .mark(SettingsCategory::Miscellaneous);
        self.mark_changed();
        Task::none()
    }
}

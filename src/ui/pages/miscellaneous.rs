...
pub fn miscellaneous_page(state: AppState) -> impl IntoView {
    ...
    let on_disable_primary_clipboard = {
        let state = state.clone();
        Rc::new(move |val: bool| {
    ...
    Stack::vertical((
        ...
        section(
            ...
            Stack::vertical((toggle_row_with_callback(
                ...
                Some(on_disable_primary_clipboard),
            ),)),
        ),
        section(
            "Hotkey Overlay",

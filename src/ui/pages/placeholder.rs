...
use crate::ui::theme::{TEXT_PRIMARY, TEXT_SECONDARY, SPACING_LG};
...
pub fn placeholder_page(category: Category) -> impl IntoView {
    Stack::vertical((
        ...
        Label::derived(|| "This page is not yet implemented.".to_string())
            .style(|s| s.font_size(14.0).color(TEXT_SECONDARY).margin_top(SPACING_LG)),
    ))
